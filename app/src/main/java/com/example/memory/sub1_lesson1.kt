...
class sub1_lesson1 : AppCompatActivity() {
    private val table = arrayOf(
        arrayOf(1, "What is the capital of France?", "Paris"),
        arrayOf(2, "What is the largest mammal?", "Blue whale"),
        arrayOf(3, "What is 2 + 2?", "4")
    )
